...
-- Dados Padrão da Loja MARIS MAKEUP
INSERT INTO public.store_settings (id, store_name, trade_name, cnpj, phone, whatsapp, email, address, receipt_footer, default_min_stock, validity_alert_days)
VALUES (
  'settings_default',
  'MARIS MAKEUP',
  'MARIS MAKEUP - Cosméticos & Beleza',
  '33.987.654/0001-22',
  '(11) 3456-7890',
  '(11) 98765-4321',
  'contato@marismakeup.com.br',
  'Av. Paulista, 1200 - Loja 15 - Bela Vista, São Paulo - SP',
  'Obrigada pela preferência! Trocas em até 7 dias com embalagem lacrada.',
  5,
  45
)
